...
var Tabs = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(Tabs, [{
    ...
    value: function render() {
      ...
      var tabsRender = React.Children.map(_children, this.renderTabs); // 渲染内容
      ...
      if (swipeable) {
        ...
        contentRender = React.Children.map(_children, function (item, index) {
          return item && item.props.children && /*#__PURE__*/React.createElement(TabPanel, _extends({}, item.props, {
